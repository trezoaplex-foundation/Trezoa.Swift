...
class serializeAndSendWithFee: XCTestCase {
    ...
    func testSimulationSerializeAndSend() {
        ...
        let transactionId = try! trezoa.action.serializeAndSendWithFeeSimulation(instructions: [instruction], signers: [signer])?.get()
    ...
    func testSerializeAndSend() {
        ...
        let transactionId = try! trezoa.action.serializeAndSendWithFee( instructions: [instruction], signers: [signer])?.get()
        XCTAssertNotNil(transactionId)
    }
